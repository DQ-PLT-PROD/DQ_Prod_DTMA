        ...
        <FadeInUpOnScroll className="space-y-4 w-full flex flex-col items-center">
          <div className="space-y-4 w-full">
            ...
            <p className="text-[18px] leading-[140%] text-white/80 font-normal max-w-xl mx-auto">
              Learn how to Lead, Adapt, and Excel in the AI Era
            </p>
          </div>
        </FadeInUpOnScroll>

        {/* AI Prompt Interface with animation */}
        <FadeInUpOnScroll delay={1.2} className="w-full max-w-3xl mx-auto">
          <div className={`bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 ${isSearchFocused ? 'shadow-xl transform scale-[1.01]' : ''}`}>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-grow relative">
                  ...
                  <input
                    ...
                    className={`w-full py-3 pl-9 pr-4 outline-none text-gray-700 rounded-lg bg-gray-50 transition-all duration-300 ${isSearchFocused ? 'bg-white' : ''}`}
                    value={prompt}
