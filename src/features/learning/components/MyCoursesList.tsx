/**
 * MyCoursesList - Course list component for the learning portal
 * Renders inside LearningScreen's main content area, not as a separate page
 */
...
const MyCoursesList: React.FC = () => {
    ...
    const handleCourseClick = (courseSlug: string) => {
        navigate(`/learning?courseId=${courseSlug}`);
    };
