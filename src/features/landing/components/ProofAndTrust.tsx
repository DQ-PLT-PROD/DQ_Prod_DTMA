...
const stats = [
  ...
  { value: "30+", label: "Skill‑Specific Masterclasses for future‑ready professionals" },
  { value: "1", label: "Industry-Recognized AI Certification" },
];
...
const stories = [
  {
    ...
    description:
      "Fatima A. used Digital Worker & Workspace lessons to automate reporting - reclaiming 20+ hours for strategic growth.",
...
const whyHighlights = [
  {
    title: "Future-proof your career for the AI era",
    description:
      "Master bite-sized, practical lessons designed to make complex digital transformation simple and actionable.",
  },
  {
    title: "Navigate change with a proven roadmap",
    description:
      "Stop guessing. Every course follows our proprietary framework—your blueprint for leading digital change in any industry.",
  },
  {
    title: "Get results without the burnout",
    description:
      "Access tools, playbooks, and frameworks you can apply immediately to scale your career or transform your organization.",
  },
];
      ...
      <PageContainer className="space-y-16">
        ...
        <div className="space-y-8">
          <FadeInUpOnScroll className="space-y-3 text-center">
            <h3 className="text-3xl font-bold text-[#030C2B]">Real Stories from Our Global Community</h3>
