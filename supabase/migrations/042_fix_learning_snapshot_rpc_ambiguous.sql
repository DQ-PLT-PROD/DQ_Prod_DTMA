-- Migration: Fix ambiguous enrollment_id reference in learning snapshot RPC

DROP FUNCTION IF EXISTS public.get_learning_snapshot(TEXT, TEXT);
...
BEGIN
    ...
    IF p_user_id IS NOT NULL THEN
        ...
        INTO v_enrollment_id, enrollment_row
        FROM public.user_enrollments e
        WHERE e.user_id::text = p_user_id
...
GRANT EXECUTE ON FUNCTION public.get_learning_snapshot(TEXT, TEXT) TO anon, authenticated, service_role;
